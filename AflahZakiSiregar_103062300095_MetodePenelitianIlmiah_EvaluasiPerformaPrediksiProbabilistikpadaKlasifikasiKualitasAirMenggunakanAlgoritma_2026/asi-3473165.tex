...
Untuk memverifikasi signifikansi statistik perbedaan akurasi antar model, dilakukan uji McNemar pada pasangan prediksi model \cite{dietterich1998approximate, demsar2006statistical}. Hasil pengujian menunjukkan: NGBoost vs XGBoost menghasilkan $p = 0{,}231$ dan NGBoost vs \textit{Random Forest} menghasilkan $p = 0{,}089$. Kedua nilai $p$ berada di atas ambang signifikansi $\alpha = 0{,}05$, sehingga perbedaan akurasi antar model tidak signifikan secara statistik. Temuan ini memperkuat argumen bahwa keunggulan kalibrasi NGBoost (ECE = 0,048 vs 0,112 pada XGBoost) dicapai tanpa mengorbankan kemampuan diskriminatif secara bermakna dari perspektif statistik.
...
\begin{tikzpicture}[scale=4.8]
    ...
    % NGBoost — paling dekat diagonal (biru, 10 bins)
    \draw[blue!80!black, line width=1.8pt]
        (0.05,0.04) -- (0.15,0.13) -- (0.25,0.23) -- (0.35,0.33) -- (0.45,0.42)
        -- (0.55,0.53) -- (0.65,0.63) -- (0.75,0.72) -- (0.85,0.83) -- (0.95,0.92);
    \filldraw[blue!80!black] (0.05,0.04) circle (0.9pt);
    \filldraw[blue!80!black] (0.15,0.13) circle (0.9pt);
    \filldraw[blue!80!black] (0.25,0.23) circle (0.9pt);
    \filldraw[blue!80!black] (0.35,0.33) circle (0.9pt);
    \filldraw[blue!80!black] (0.45,0.42) circle (0.9pt);
    \filldraw[blue!80!black] (0.55,0.53) circle (0.9pt);
    \filldraw[blue!80!black] (0.65,0.63) circle (0.9pt);
    \filldraw[blue!80!black] (0.75,0.72) circle (0.9pt);
    \filldraw[blue!80!black] (0.85,0.83) circle (0.9pt);
    \filldraw[blue!80!black] (0.95,0.92) circle (0.9pt);
    % XGBoost — overconfident (merah, 10 bins)
    \draw[red!75!black, line width=1.8pt]
        (0.05,0.03) -- (0.15,0.10) -- (0.25,0.17) -- (0.35,0.25) -- (0.45,0.34)
        -- (0.55,0.44) -- (0.65,0.53) -- (0.75,0.62) -- (0.85,0.73) -- (0.95,0.82);
    \filldraw[red!75!black] (0.05,0.03) circle (0.9pt);
    \filldraw[red!75!black] (0.15,0.10) circle (0.9pt);
    \filldraw[red!75!black] (0.25,0.17) circle (0.9pt);
    \filldraw[red!75!black] (0.35,0.25) circle (0.9pt);
    \filldraw[red!75!black] (0.45,0.34) circle (0.9pt);
    \filldraw[red!75!black] (0.55,0.44) circle (0.9pt);
    \filldraw[red!75!black] (0.65,0.53) circle (0.9pt);
    \filldraw[red!75!black] (0.75,0.62) circle (0.9pt);
    \filldraw[red!75!black] (0.85,0.73) circle (0.9pt);
    \filldraw[red!75!black] (0.95,0.82) circle (0.9pt);
    % Random Forest (hijau, 10 bins)
    \draw[green!55!black, line width=1.8pt]
        (0.05,0.04) -- (0.15,0.11) -- (0.25,0.19) -- (0.35,0.28) -- (0.45,0.37)
        -- (0.55,0.47) -- (0.65,0.56) -- (0.75,0.66) -- (0.85,0.77) -- (0.95,0.85);
    \filldraw[green!55!black] (0.05,0.04) circle (0.9pt);
    \filldraw[green!55!black] (0.15,0.11) circle (0.9pt);
    \filldraw[green!55!black] (0.25,0.19) circle (0.9pt);
    \filldraw[green!55!black] (0.35,0.28) circle (0.9pt);
    \filldraw[green!55!black] (0.45,0.37) circle (0.9pt);
    \filldraw[green!55!black] (0.55,0.47) circle (0.9pt);
    \filldraw[green!55!black] (0.65,0.56) circle (0.9pt);
    \filldraw[green!55!black] (0.75,0.66) circle (0.9pt);
    \filldraw[green!55!black] (0.85,0.77) circle (0.9pt);
    \filldraw[green!55!black] (0.95,0.85) circle (0.9pt);
    % Legend
...
\begin{tikzpicture}[scale=4.8]
    ...
    \draw[gray!65, dashed, line width=1.2pt] (0,0) -- (1,1);
    % NGBoost ROC curve (AUC = 0.76)
    \draw[blue!80!black, line width=1.8pt]
        (0,0) -- (0.05,0.18) -- (0.10,0.32) -- (0.15,0.42) -- (0.20,0.50)
        -- (0.30,0.62) -- (0.40,0.71) -- (0.50,0.78) -- (0.60,0.84)
        -- (0.70,0.89) -- (0.80,0.93) -- (0.90,0.97) -- (1.0,1.0);
    % XGBoost ROC curve (AUC = 0.78)
    \draw[red!75!black, line width=1.8pt]
        (0,0) -- (0.05,0.20) -- (0.10,0.35) -- (0.15,0.45) -- (0.20,0.53)
        -- (0.30,0.65) -- (0.40,0.74) -- (0.50,0.81) -- (0.60,0.86)
        -- (0.70,0.91) -- (0.80,0.95) -- (0.90,0.98) -- (1.0,1.0);
    % Random Forest ROC curve (AUC = 0.73)
    \draw[green!55!black, line width=1.8pt]
        (0,0) -- (0.05,0.15) -- (0.10,0.28) -- (0.15,0.37) -- (0.20,0.45)
        -- (0.30,0.57) -- (0.40,0.66) -- (0.50,0.74) -- (0.60,0.80)
        -- (0.70,0.86) -- (0.80,0.91) -- (0.90,0.95) -- (1.0,1.0);
    % Legend
    \draw[blue!80!black, line width=1.8pt] (0.55,0.22) -- (0.63,0.22);
    \node[right, font=\scriptsize] at (0.64,0.22) {NGBoost (AUC\,=\,0,76)};
    \draw[red!75!black, line width=1.8pt] (0.55,0.15) -- (0.63,0.15);
    \node[right, font=\scriptsize] at (0.64,0.15) {XGBoost (AUC\,=\,0,78)};
    \draw[green!55!black, line width=1.8pt] (0.55,0.08) -- (0.63,0.08);
    \node[right, font=\scriptsize] at (0.64,0.08) {\textit{Random Forest} (AUC\,=\,0,73)};
...
Hasil analisis ROC-AUC menunjukkan bahwa XGBoost memiliki nilai AUC tertinggi (0,78), diikuti NGBoost (0,76) dan \textit{Random Forest} (0,73). Selisih AUC antara XGBoost dan NGBoost sebesar 0,02 mengindikasikan bahwa XGBoost memiliki kemampuan diskriminatif yang sedikit lebih tinggi. Namun, temuan ini justru memperkuat argumen utama penelitian: keunggulan NGBoost tidak terletak pada kemampuan diskriminatif murni, melainkan pada kualitas kalibrasi probabilistik. Meskipun XGBoost mampu memisahkan kelas positif dari kelas negatif secara marginal lebih baik, probabilitas yang dihasilkannya tidak terkalibrasi dengan baik (ECE = 0,112 vs 0,048). Dalam konteks pengambilan keputusan berisiko pada manajemen kualitas air, kalibrasi yang akurat lebih penting daripada diskriminasi marginal, karena operator memerlukan estimasi probabilitas yang dapat diandalkan untuk menentukan tindakan yang tepat.
